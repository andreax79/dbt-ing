...
def repair_external_tables(flow, athena_location, include_target_tables=None):
    ...
    qm = QueryManager(athena_location=athena_location)
    for table in tables:
...
def drop_external_tables(flow, athena_location, include_target_tables=None):
...
def create_external_tables(flow, athena_location, include_target_tables=None):
